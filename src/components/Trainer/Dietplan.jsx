             ...
             <form onSubmit={handleSubmit} className='space-y-4'>
   ...
   
               {
                form.meals.map((meal,index)=>(
                  <div key={index} className='flex p-5 rounded-2xl flex-col gap-y-2 w-full bg-blue-200'>
                        <p>{meal.type}</p>
                        { meal.items.map((items,itemindex)=>(
                 ...
                 placeholder='Items' required></input>
                        ...
                        <div>
                        <button type='button' onClick={()=>addItems(index)} className='text-sm text-blue-600 mt-2'>
                  + Add Items
                </button>
                        </div>
                  </div>
