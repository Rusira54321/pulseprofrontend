...
const Successfullpaymentpage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-green-200 via-gray-900 to-black">
      <motion.div
        initial={{ scale: 0.7, opacity: 0, y: 40 }}
        animate={{ scale: 1, opacity: 1, y: 0 }}
        transition={{ type: 'spring', stiffness: 200, damping: 18 }}
        className="bg-white/90 rounded-2xl shadow-2xl p-10 flex flex-col items-center gap-6"
      >
        <motion.div
        ...
        >
          Thank you for your payment. Your transaction was successful and your membership has been updated.
        </motion.p>
        <motion.a
          href="/admin/dashbaord/displayMember"
