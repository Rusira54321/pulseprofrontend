      ...
      <div className='flex w-full max-w-5xl flex-col mt-20 gap-x-5 gap-y-5 items-center bg-gray-900 p-6 rounded-lg shadow-lg'>
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className='cursor-pointer border-2 rounded-full p-2 transition-all duration-300 hover:bg-green-400 z-10'
            style={{ position: 'absolute', left: 0 }}
          >
            <ChevronLeft className='text-white' />
          </motion.button>

          <p className='text-white text-2xl font-semibold mx-auto'>{date}</p>

          {/* Placeholder div to balance the left button */}
